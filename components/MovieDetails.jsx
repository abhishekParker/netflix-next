    ...
    <>
      ...
      <div className="container">
        <div className="flex flex-col space-y-2 py-16 md:space-y-4 h-[100vh] justify-center lg:pb-12">
          ...
          <h1 className="text-2xl font-bold md:text-4xl lg:texto-7xl">
            {movie?.title || movie?.name || movie?.original_name}
          </h1>
          <p className="max-w-xs text-xs md:text-lg md:max-w-lg lg:max-w-2xl lg:text-2xl">
            {movie?.overview}
          </p>
          ...
          <div className="flex space-x-3">
            ...
            <button className="bannerButton bg-[gray]/70">
              <IoIosInformationCircle className="h-4 w-4 text-black md:h-8 md:w-8" />
              More Info
            </button>
          </div>
        </div>
